            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Films
                    </div>
                    <div class="card-toolbar">

                        <!--begin::Button-->
                        <a href="{{ route('films.create') }}" class="btn btn-primary font-weight-bolder">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="film in films">
                                    ...
                                    <td class="datatable-cell">
                                        <img :src="film.image" style="width: 40%;">
                                        
                                    </td>
                                    
                                    <td>
                                        <a class="btn btn-info" :href="'{{ url('/films/edit') }}'+'/'+film.id"><i class="far fa-edit"></i></a>
                                        <button class="btn btn-secondary" @click="erase(film.id)"><i class="far fa-trash-alt"></i></button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
