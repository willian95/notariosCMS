            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Directores
                    </div>
                    <div class="card-toolbar">

                        <!--begin::Button-->
                        <a href="{{ route('directors.create') }}" class="btn btn-primary font-weight-bolder">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="director in directors">
                                    ...
                                    <td>
                                        <a class="btn btn-info" :href="'{{ url('/directors/edit') }}'+'/'+director.id"><i class="far fa-edit"></i></a>
                                        <button class="btn btn-secondary" @click="erase(director.id)"><i class="far fa-trash-alt"></i></button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
