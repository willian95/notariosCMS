                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea rows="3" id="editorDescription">{!! $director->description !!}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" v-model="vimeoLink">
                                <small v-if="errors.hasOwnProperty('name')">@{{ errors['name'][0] }}</small>
                                ...
                                <tbody>
                                    <tr v-for="(workImage, index) in workImages">
                                        ...
                                        <td>
                                            ...
                                            <video class="w-100" controls v-if="workImage.finalName != '' && workImage.type == 'video'">
