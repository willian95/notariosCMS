                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="project in projects">
                                    ...
                                    <td class="datatable-cell">
                                        <img v-if="project.image_type == 'image'" :src="project.image" style="width: 40%;">
                                        <video class="w-100" controls v-if="project.image_type == 'video'">
                                            <source :src="project.image" type="video/mp4">
                                            <source :src="project.image" type="video/ogg">
                                            Your browser does not support the video tag.
                                        </video>
                                    </td>
                                    
                                    <td>
                                        <a class="btn btn-info" :href="'{{ url('/projects/edit') }}'+'/'+project.id"><i class="far fa-edit"></i></a>
